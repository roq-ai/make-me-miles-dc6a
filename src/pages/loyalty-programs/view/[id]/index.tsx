...
import { getLoyaltyProgramById } from 'apiSdk/loyalty-programs';
...
function LoyaltyProgramViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Loyalty Program Detail View
          </Text>
          {hasAccess('loyalty_program', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/loyalty-programs/edit/${data?.id}`} passHref legacyBehavior>
              <Button
